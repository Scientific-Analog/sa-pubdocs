---
title: "XMODEL primitive: clk_gen"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: clk_gen
primitive_category: stim
description: "A digital clock generator."
date: 2026-03-11T07:20:43.451081
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE clk_gen
A digital clock generator.

The `clk_gen` primitive generates an xbit-typed, periodic clock signal with a frequency and initial phase specified by the parameters `freq` and `init_phase`, respectively. The primitive can also add sinusoidal jitter, random jitter, or phase noise to the generated clock.

As for the sinusoidal jitter (SJ), the parameters `SJ_amp`, `SJ_freq`, and `SJ_phase` set the amplitude, frequency, and phase of the sinusoidal jitter, respectively. This SJ generation capability is useful when performing jitter transfer or jitter tolerance simulations.

The phase noise of the output clock can be specified using the phase noise parameters `PN_fcenter`, `PN_foffset`, `PN_dbc`, `PN_fcorner`, and `PN_floor`, assuming the phase noise spectrum of a typical oscillator consisting of 1/f^3 noise, 1/f^2 noise, and noise floor (ref: D. B. Leeson, "A Simple Model of Feedback Oscillator Noise Spectrum," in Proceedings of the IEEE, vol. 54, Feb. 1966, pp. 329–330). These phase noise parameters take effects only when the parameter `PN_fcenter` has a positive value (default: -1.0).
...
|:-----|:-----|:--------|:-----|:------------|
| freq | real | 1.0e9 | Hz | clock frequency |
| init_phase | real | 0.0 | radian | initial clock phase |
| SJ_amp | real | 0.0 | UI | sinusoidal jitter amplitude |
| SJ_freq | real | 0.0 | Hz | sinusoidal jitter frequency |
| SJ_phase | real | 0.0 | radian | sinusoidal jitter phase |
