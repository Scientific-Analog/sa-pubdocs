---
title: "XMODEL primitive: nand_xbit"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: nand_xbit
primitive_category: gate
description: "A multi-input NAND gate with xbit-typed input/output's."
date: 2026-03-11T07:20:43.569463
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE nand_xbit
A multi-input NAND gate with xbit-typed input/output's.

The `nand_xbit` primitive models a multi-input NAND logic gate with xbit-typed signals. It is suitable for processing digital signals of which precise timing information must be preserved.

The input to the `nand_xbit` primitive is an xbit array, of which length is specified by the parameter `num_in`.
