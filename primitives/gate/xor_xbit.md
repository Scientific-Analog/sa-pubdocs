---
title: "XMODEL primitive: xor_xbit"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: xor_xbit
primitive_category: gate
description: "A multi-input XOR gate with xbit-type input/output's."
date: 2026-03-11T07:20:43.576639
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE xor_xbit
A multi-input XOR gate with xbit-type input/output's.

The `xor_xbit` primitive models a multi-input XOR logic gate with xbit-typed signals. It is suitable for processing digital signals of which precise timing information must be preserved.

The input to the `xor_xbit` primitive is an xbit array, of which length is specified by the parameter `num_in`.
