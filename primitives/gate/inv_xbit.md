---
title: "XMODEL primitive: inv_xbit"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: inv_xbit
primitive_category: gate
description: "A logic inverter gate with xbit-typed input/output's."
date: 2026-03-11T07:20:43.565751
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE inv_xbit
A logic inverter gate with xbit-typed input/output's.

The `inv_xbit` primitive models a logic inverter gate with xbit-typed signals. It is suitable for processing digital signals of which precise timing information must be preserved.
...
The parameter `twostate` is provided for legacy support. When set to 1, the primitive enforces a 2-state output by producing logic 0 outputs whenever the input has a logic X or logic Z value. For the `inv_xbit` primitive, this is equivalent to setting both `valueX` and `valueZ` to 1.
