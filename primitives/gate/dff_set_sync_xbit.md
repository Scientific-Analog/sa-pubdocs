---
title: "XMODEL primitive: dff_set_sync_xbit"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: dff_set_sync_xbit
primitive_category: gate
description: "A D flip-flop with xbit-type input/output's and synchronous set."
date: 2026-03-11T07:20:43.560633
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE dff_set_sync_xbit
A D flip-flop with xbit-type input/output's and synchronous set.

The `dff_set_sync_xbit` primitive models a D flip-flop with a data input `d`, a clock input `clk`, an output `q`, and a synchronous set input `set`. All the input and output signals are xbit-typed. This primitive is suitable when processing digital signals with precise timing information.
