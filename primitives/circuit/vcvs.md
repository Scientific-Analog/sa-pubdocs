---
title: "XMODEL primitive: vcvs"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: vcvs
primitive_category: circuit
description: "A voltage-controlled voltage source (VCVS)."
date: 2026-03-11T07:20:43.543376
...
The `vcvs` primitive represents a dependent voltage source controlled by a voltage across two circuit terminals. This primitive is a pseudo-module to describe a structural netlist of electrical circuits and not a behavioral model by itself. The XMODEL simulator extracts an event-driven behavioral model at run-time based on the circuit network described by these circuit-level pseudo-modules.
