---
title: "XMODEL primitive: tline_var"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: tline_var
primitive_category: circuit
description: "A single-conductor, two-port transmission line with variable delay."
date: 2026-03-11T07:20:43.538434
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE tline_var
A single-conductor, two-port transmission line with variable delay.

The `tline_var` primitive models a single-conductor, two-port transmission line with a characteristic impedance of `Z0` and variable propagation delay. The variable delay is controlled by the xreal-typed input `delay`.
...
| delay | input | xreal | line propagation delay |
