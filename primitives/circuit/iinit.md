---
title: "XMODEL primitive: iinit"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: iinit
primitive_category: circuit
description: "An initial conditioning element for a branch current."
date: 2026-03-11T07:20:43.510428
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE iinit
An initial conditioning element for a branch current.

The `iinit` primitive sets the initial condition of a branch current. In other words, the current through the two terminals `pos` and `neg` is set close to the specified value of `ic`.
