---
title: "XMODEL primitive: check_duty"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: check_duty
primitive_category: meas
description: "A primitive for checking the duty-cycle of an xbit-type clock input."
date: 2026-03-11T07:20:43.390654
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE check_duty
A primitive for checking the duty-cycle of an xbit-type clock input.

The `check_duty` primitive measures the duty-cycle of an xbit-type clock input `in` and checks whether its value falls within a specified range. The parameter `range` defines the valid range of duty-cycle, using a two-element real-typed array formatted as '{min_value, max_value}. The parameter `trig_edge` specifies which edges of the input clock trigger checking: positive edges (+1), negative edges (-1), or both (0). Violations are checked only when the input `enable` is high (1).
...
|:-----|:-----|:--------|:-----|:------------|
| range | real array | '{0.0, 1.0} | None | valid range of duty-cycle [min, max] |
