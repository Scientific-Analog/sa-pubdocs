---
title: "XMODEL primitive: check_freq"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: check_freq
primitive_category: meas
description: "A primitive for checking the frequency of an xbit-type clock input."
date: 2026-03-11T07:20:43.391914
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE check_freq
A primitive for checking the frequency of an xbit-type clock input.

The `check_freq` primitive measures the frequency of an xbit-type clock input `in` and checks whether its value falls within a specified range. The parameter `range` defines the valid range of frequency, using a two-element real-typed array formatted as '{min_value, max_value}. The parameter `trig_edge` specifies which edges of the input clock trigger checking: positive edges (+1), negative edges (-1), or both (0). Violations are checked only when the input `enable` is high (1).
...
|:-----|:-----|:--------|:-----|:------------|
| range | real array | '{0.0, 0.0} | None | valid range of frequency [min, max] |
