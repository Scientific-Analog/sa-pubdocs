---
title: "XMODEL primitive: probe_freq"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: probe_freq
primitive_category: meas
description: "A frequency probe for a clock signal."
date: 2026-03-11T07:20:43.430783
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE probe_freq
A frequency probe for a clock signal.

The `probe_freq` primitive measures the frequency of an xbit-typed periodic clock input (`in`) and records its waveform into a file. The primitive uses a `clk_to_freq` primitive to measure the frequency of `in`.
...
|:-----|:----|:-----|:------------|
| in | input | xbit | signal to measure the frequency from |
