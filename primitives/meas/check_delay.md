---
title: "XMODEL primitive: check_delay"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: check_delay
primitive_category: meas
description: "A primitive for checking the delay of an xbit-type signal."
date: 2026-03-11T07:20:43.388006
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE check_delay
A primitive for checking the delay of an xbit-type signal.

The `check_delay` primitive measures the delay of an xbit-typed input `in` relative to a reference input (`in_ref`) and checks whether the delay falls within a specified range. This range of delay is defined by the parameter `range`, which is a two-element real-typed array formatted as '{min_delay, max_delay}. Violations are checked only when the input `enable` is high (1).
