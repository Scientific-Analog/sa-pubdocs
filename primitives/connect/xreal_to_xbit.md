---
title: "XMODEL primitive: xreal_to_xbit"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: xreal_to_xbit
primitive_category: connect
description: "An xreal-to-xbit connector."
date: 2026-03-11T07:20:43.498147
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE xreal_to_xbit
An xreal-to-xbit connector.

The `xreal_to_xbit` primitive converts an xreal-type signal to an xbit-type signal. The analog level of the input signal is converted to a digital level using the threshold parameters: threshold, thres0, or thres1.
