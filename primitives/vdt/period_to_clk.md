---
title: "XMODEL primitive: period_to_clk"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: period_to_clk
primitive_category: vdt
description: "A period-to-clock domain translator."
date: 2026-03-11T07:20:43.605851
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE period_to_clk
A period-to-clock domain translator.

The `period_to_clk` primitive takes an xreal-typed input `in` expressing a clock period and produces xbit-typed clock signals `out` with the corresponding period. The primitive can also produce multiple clocks with uniformly-spaced phases as well as clocks with phase noise or random jitter.
