---
title: "XMODEL primitive: phase_to_clk"
document_type: reference
reference_type: primitive
product: XMODEL
primitive: phase_to_clk
primitive_category: vdt
description: "A phase-to-clock domain translator."
date: 2026-03-11T07:20:43.607247
company: "Scientific Analog, Inc."
license: "Copyright (c) Scientific Analog, Inc."
---

# PRIMITIVE phase_to_clk
A phase-to-clock domain translator.

The `phase_to_clk` primitive takes an xreal-typed input `in` expressing a clock phase and produces xbit-typed clock signals `out` with a frequency `freq` and the corresponding phase. The primitive can also produce multiple clocks with uniformly-spaced phases as well as clocks with phase noise or random jitter.

The parameter `num_phase` sets the number of output clock phases and the parameter `freq` sets the nominal frequency of the output clocks.
